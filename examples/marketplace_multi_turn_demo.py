...
import src.ice_tools.toolkits.marketplace.conversation_agent
import src.ice_tools.toolkits.marketplace.listing_status_agent
...
async def test_conversation_memory():
    ...
    print("📅 **Session 1**")
    messages1 = [
        {"role": "user", "content": "Is the refrigerator available?"}
    ]
