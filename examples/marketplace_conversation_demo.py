...
async def demo_simple_inquiry():
    ...
    agent_class = global_agent_registry.get_agent_class("marketplace_conversation_agent")
    agent = agent_class()
...
async def main():
    ...
    print(f"✅ Registered {len(toolkit.get_tools())} tools and {len(toolkit.get_agents())} agents")
    print()
