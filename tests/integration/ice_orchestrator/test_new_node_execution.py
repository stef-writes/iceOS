...
async def test_human_executor_basic():
    ...
    config = HumanNodeConfig(
        id="test_human",
        prompt_message="Please approve this action"
    )
...
async def test_human_executor_with_timeout():
    ...
    config = HumanNodeConfig(
        id="test_human",
        prompt_message="Test with timeout",
        timeout_seconds=30
    )
...
async def test_all_executors_handle_errors_gracefully():
    ...
    invalid_monitor_config = MonitorNodeConfig(
        id="invalid_monitor", 
        metric_expression="invalid >> syntax"
    )
...
async def test_executors_record_metrics():
    ...
    # Test human metrics
    human_config = HumanNodeConfig(
        id="metrics_human",
        prompt_message="Test metrics"
    )
