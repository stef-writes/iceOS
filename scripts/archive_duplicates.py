...
class CodeArchiver:
    ...
    def archive_files(self, files_to_archive: list) -> None:
        ...
        print(f"📁 Creating archive at: {self.archive_root}")
        ...
        for file_info in files_to_archive:
            ...
            if not src.exists():
                print(f"⚠️  Skipping {old_path} (doesn't exist)")
                continue
...
def main():
    ...
    print("\n✅ Archiving complete!")
    print(f"📁 Archive location: {archiver.archive_root}")
