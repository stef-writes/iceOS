...
class SharedMemoryPool:
    ...
    async def retrieve(self, key: str, memory_type: str = "working") -> Optional[Any]:
    ...
    async def clear(self, memory_type: Optional[str] = None) -> None:
        ...
        memory_types = (
            [memory_type] if memory_type else ["working", "episodic", "semantic"]
        )
...
class SharedMemoryService:
    ...
    async def get_pool(
        self, pool_name: str, ttl_seconds: int = 3600, auto_create: bool = True
    ) -> SharedMemoryPool:
    ...
    async def get_global_stats(self) -> Dict[str, Any]:
        ...
        stats: dict[str, Any] = {"total_pools": len(self._pools), "pools": {}}
