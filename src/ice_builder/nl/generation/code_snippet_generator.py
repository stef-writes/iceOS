...
class CodeSnippetGenerator:
    ...
    def _generate_custom_code(self, node_id: str, description: str, node_type: str) -> str:
    ...
    def _extract_operations(self, description: str) -> List[str]:
        ...
        operation_verbs = [
            "read", "write", "process", "transform", "filter", "aggregate",
            "calculate", "generate", "create", "update", "delete", "send",
            "fetch", "parse", "validate", "convert", "merge", "split"
        ]
