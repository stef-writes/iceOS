...
"""InsightsSkill – extract actionable insights from a summary using an LLM."""
...
__all__: list[str] = ["InsightsSkill"]
...
class InsightsSkill(SkillBase):
    ...
    async def _execute_impl(self, **kwargs: Any) -> Dict[str, Any]:
        try:
            ...
            raise SkillExecutionError(f"Invalid InsightsSkill input: {exc}") from exc
