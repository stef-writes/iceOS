...
_warnings.warn(
    "'ice_sdk.tools.registry' is the canonical registry; the old 'ice_sdk.skills.registry' path has been removed.",
    DeprecationWarning,
    stacklevel=2,
)
...
class SkillRegistry(BaseModel):
    ...
    def get_agents(self):  # type: ignore[override]
        ...
        from ice_sdk.tools.base import SkillMeta  # local import to avoid cycles
