...
class BaseWorkflow(ABC):
    ...
    # ------------------------------------------------------------------ abstract API
    @abstractmethod
    async def execute(self) -> NodeExecutionResult:  # noqa: D401
        pass

    @abstractmethod
    def get_node_dependencies(self, node_id: str) -> List[str]:  # noqa: D401
        pass

    @abstractmethod
    def get_node_dependents(self, node_id: str) -> List[str]:  # noqa: D401
        pass

    @abstractmethod
    def get_node_level(self, node_id: str) -> int:  # noqa: D401
        pass

    @abstractmethod
    def get_level_nodes(self, level: int) -> List[str]:  # noqa: D401
        pass

    @abstractmethod
    def get_metrics(self) -> Dict[str, Any]:  # noqa: D401
        pass
...
BaseScriptChain = BaseWorkflow  # type: ignore
