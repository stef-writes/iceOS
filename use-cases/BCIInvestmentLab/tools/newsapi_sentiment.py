...
class NewsApiSentimentTool(ToolBase):
    ...
    def __init__(self):
        """Initialize NewsAPI sentiment analysis tool."""
        super().__init__()
        
        # NewsAPI configuration (free tier)
        self.base_url = "https://newsapi.org/v2"
        self.free_tier_limit = 100  # articles per day
        self.requests_per_day = 500  # API calls per day
