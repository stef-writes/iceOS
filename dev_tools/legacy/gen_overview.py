# Copy of scripts/gen_overview.py – kept for reference
...
def build_markdown(pkgs: List[PackageInfo]) -> str:
    lines: List[str] = [
        ...
        "",
        "> Generated by dev_tools/legacy/gen_overview.py",
        "",
        "## Packages",
        "",
    ]
...
def main():
    ...
    print(f"[legacy.gen_overview] wrote {len(pkgs)} entries to {OUTPUT_FILE}")
